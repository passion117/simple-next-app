    ...
    <div>
      ...
      <main className={`relative flex flex-col items-center justify-between ${inter.className}`}>
        ...
        <div className={styles.btn}>
          <button className={styles.signUpBtn} onClick={goDescription}>無料で始める</button>
          {/* <RModal isOpen={isROpen} onClose={handleCloseRModal} />
          <button className={styles.loginBtn} onClick={handleOpenLModal}>メールでログイン</button>
          <LModal isOpen={isLOpen} onClose={handleCloseLModal} /> */}
